  ...
  return (
    <div>
      {!added ? (
        <button
          onClick={handleAdd}
          className=" bg-green-600 text-white px-6 py-2 rounded-lg  opacity-0 group-hover:opacity-100 transition-opacity duration-300"
        >
      ...
      {
        showUpPopup&&(
            <div className="fixed top-12 left-1/2 -translate-x-1/2 bg-white border-1 border-gray-300 p-4 rounded-lg shadow-lg z-50">
