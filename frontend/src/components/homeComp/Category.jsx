  ...
  return (
    <div className="flex flex-col mx-auto items-center px-[6%]">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 mt-10 mb-20">
            <div className="flex flex-col items-center justify-center p-6 border-3 border-gray-100 rounded-xl hover:shadow-lg transition-shadow duration-300 hover:scale-110">
